    ...
    $.fn.myOwnDialog = function( options )
    {
        ...
        if(options=="open")
        {
            return this.each(function()
            {
                ...
                var modal_x=0;
                var modal_y=0;
                var modal_box_left=0;
                var modal_box_top=0;
                var modal_box_width=0;
                var modal_box_height=0;
                var modal_box_new_left=0;
                var modal_box_new_top=0;

                var modal_box_bottom_from_top=0;
                var modal_box_bottom_dust=0;

                var modal_box_right_from_left=0;
                var modal_box_right_dust=0;

                var modal_box_top_dust=0;
                var modal_box_bottom_fixed=0;

                var modal_box_left_dust=0;
                var modal_box_right_fixed=0;

                var dialog_id=$(this).attr("data-dialogId");
                var dialog_resize=$(this).attr("data-dialogResizable");
                var dialog_move=$(this).attr("data-dialogMovable");
                var dialog_auto_close=$(this).attr("data-dialogAutoClose");
                ...
                if(dialog_move=="true")
                {
                    $(this).find(".titlebar_left").mousedown(function(e)
                    {
                        if(modal_box=="rest")
                        {
                            modal_x=e.pageX;
                ...
                {
                    $(this).find(".mdl_bottom").mousedown(function(e)
                    {
                        if(modal_box=="rest")
                        {
                            modal_x=e.pageX;
                    ...
                    $(this).find(".mdl_right").mousedown(function(e)
                    {
                        if(modal_box=="rest")
                        {
                            modal_x=e.pageX;
                    ...
                    $(this).find(".mdl_bottom_right").mousedown(function(e)
                    {
                        if(modal_box=="rest")
                        {
                            modal_x=e.pageX;
                    ...
                    $(this).find(".mdl_top").mousedown(function(e)
                    {
                        if(modal_box=="rest")
                        {
                            modal_x=e.pageX;
                    ...
                    $(this).find(".mdl_left").mousedown(function(e)
                    {
                        if(modal_box=="rest")
                        {
                            modal_x=e.pageX;
                    ...
                    $(this).find(".mdl_top_left").mousedown(function(e)
                    {
                        if(modal_box=="rest")
                        {
                            modal_x=e.pageX;
                    ...
                    $(this).find(".mdl_top_right").mousedown(function(e)
                    {
                        if(modal_box=="rest")
                        {
                            modal_x=e.pageX;
                    ...
                    $(this).find(".mdl_bottom_left").mousedown(function(e)
                    {
                        if(modal_box=="rest")
                        {
                            modal_x=e.pageX;
